// Five RGB stops going cold blue → warm cream pivot → warm red, shared by every
// temperature scale. The stops are pinned to either absolute degrees (comfort) or
// a data range (relative).
const COLORS = [
...
// Even-ish stop positions (0..1) for the relative (diverging) ramp.
const FRACTIONS = [0, 0.25, 0.5, 0.72, 1.0];
...
function interpolate(positions, value) {
